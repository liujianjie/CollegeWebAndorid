...
/**
 * 杩欎釜鏄繘鍏ョ浉鍐屾樉绀烘墍鏈夊浘鐗囩殑鐣岄潰
 * 
 * @author king
 * @QQ:595163260
 * @version 2014骞�0鏈�8鏃� 涓嬪崍11:47:15
 */
public class AlbumActivity extends Activity {
	//鏄剧ず鎵嬫満閲岀殑鎵�湁鍥剧墖鐨勫垪琛ㄦ帶浠�	private GridView gridView;
	//褰撴墜鏈洪噷娌℃湁鍥剧墖鏃讹紝鎻愮ず鐢ㄦ埛娌℃湁鍥剧墖鐨勬帶浠�	private TextView tv;
	//gridView鐨刟dapter
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = this;
		//娉ㄥ唽涓�釜骞挎挱锛岃繖涓箍鎾富瑕佹槸鐢ㄤ簬鍦℅alleryActivity杩涜棰勮鏃讹紝闃叉褰撴墍鏈夊浘鐗囬兘鍒犻櫎瀹屽悗锛屽啀鍥炲埌璇ラ〉闈㈡椂琚彇娑堥�涓殑鍥剧墖浠嶅浜庨�涓姸鎬�		IntentFilter filter = new IntentFilter("data.broadcast.action");  
	...
	// 棰勮鎸夐挳鐨勭洃鍚�	private class PreviewListener implements OnClickListener {
	...
	// 瀹屾垚鎸夐挳鐨勭洃鍚�	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
	...
	// 鍙栨秷鎸夐挳鐨勭洃鍚�	private class CancelListener implements OnClickListener {
		public void onClick(View v) {
