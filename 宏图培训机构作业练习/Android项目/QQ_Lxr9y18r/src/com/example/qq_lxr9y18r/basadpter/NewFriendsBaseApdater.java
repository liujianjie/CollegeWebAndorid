...
import com.example.qq_lxr9y18r.NewFriendActivity;
import com.example.qq_lxr9y18r.R;
import com.example.qq_lxr9y18r.SelHaoYouActivity;
import com.example.qq_lxr9y18r.XiangQingFriendActivity;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewholder.newfriendsitem_tv_name.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("flag", (int)v.getTag());
