						...
						<div class="box col-md-12">
							<div class="box-inner" style="height: 300px;">
								<div class="box-header well" data-original-title="">
									<h2>
										<i class=" glyphicon glyphicon-list-alt"></i> 公告详情
									</h2>
								...
								<div class="box-content">
									...
									<div class="form-group"
										style="height: 40px; width: 450px; display: inline-block; margin-bottom: 0; vertical-align: middle; margin-left: 15px;">
								...
								<div class="box-content">
									...
									<div class="box-content">
										...
										<div class="form-group"
											...
											<textarea class="autogrow" cols="80" rows="7"
												id="kind_editor">${msg.msgcon }</textarea>
										</div>
									</div>
								</div>
							</div>
