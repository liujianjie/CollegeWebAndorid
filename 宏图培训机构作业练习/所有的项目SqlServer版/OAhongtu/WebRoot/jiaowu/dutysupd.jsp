						...
						<div class="box col-md-12">
							<div class="box-inner" style="height: 500px;">
								<div class="box-header well" data-original-title="">
									<h2>
										<i class="glyphicon glyphicon-edit"></i> 修改值班记录
									</h2>
								...
								<div class="box-content">
									<form role="form" action="chenru/upddutys.action" method="post">
										<input type="hidden" class="form-con0trol"
											name="dutys.dsid" value="${dutys.dsid }">
										...
										<div class="box-content">
											...
											<div class="controls"
												...
												<select name="dutys.dsempid" data-rel="chosen"
													style="width: 165px;">
													<option>
														--请选择值班人--
													</option>
													<c:forEach items="${listemp}" var="emp">
														<option value="${emp.eid}" ${emp.eid==dutys.dsempid?'selected':''}>
															${emp.ename }
														</option>
													</c:forEach>
												</select>
										...
										<div class="box-content">
											...
											<div class="control-group"
												style="height: 40px; width: 250px; display: inline-block; margin-bottom: 0; vertical-align: middle; margin-left: 15px">
												<input type="text" class="form-control"
													name="dutys.dstime" value="${dutys.dstime }"
											...
											<div class="form-group"
												...
												<input type="text" class="form-control"
													name="dutys.dsplace" value="${dutys.dsplace}">
											</div>
										</div>
										...
										<div class="box-content">
											...
											<div class="form-group"
												...
												<textarea class="autogrow" cols="100" rows="7"
													name="dutys.dspro" id="kind_editor">${dutys.dspro }</textarea>
											</div>
										</div>
										...
										<div class="box-content">
											<div class="control-group">
												<button type="submit" class="btn btn-default"
													style="width: 100px; margin-left: 320px; margin-top:105px;">
													<b>修 改</b>
												</button>
											</div>
										</div>
