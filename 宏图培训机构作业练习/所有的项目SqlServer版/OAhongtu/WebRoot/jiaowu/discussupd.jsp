						...
						<div class="box col-md-12">
							<div class="box-inner" style="height: 800px;">
								<div class="box-header well" data-original-title="">
									<h2>
										<i class="glyphicon glyphicon-edit"></i> 修改研讨会记录
									</h2>
								...
								<div class="box-content">
									<form role="form" action="chenru/upddis.action" method="post">
										<input type="hidden" class="form-con0trol"
											name="discuss.disid" value="${discuss.disid }">
										...
										<div class="box-content">
											...
											<textarea id="tt" class="autogrow" rows="5" cols="105" style="margin-left:70px;" name="discuss.empid">${discuss.empid }</textarea>
											</div> 
											</div>
											<br/><br/><br/>
