						...
						<div class="box col-md-12">
							<div class="box-inner">
								<div class="box-header well" data-original-title="">
									<h2>
										<i class="glyphicon glyphicon-th-list"></i> 值班管理
									</h2>

								</div>
								<div class="box-content">
									<div class="alert alert-info" style="height: 70px;">
										<a class="btn btn-success" href="chenru/listempduty.action"
											style="float: right;"> <i
											class="glyphicon glyphicon-pencil"></i> 添加值班记录 </a>
									</div>
									...
									<table
										...
										<tbody>
											<c:forEach items="${list}" var="dutys">
												<tr>
													<td>
														${dutys.DSID}
													</td>
													...
													<c:forEach items="${listemp}" var="emp">
														<c:if test="${dutys.DSEMPID == emp.eid}">
															${emp.ename }
														</c:if>
														</c:forEach>
													</td>
													...
													<td class="center">
														<a class="btn btn-primary"
															href="chenru/toupddutys.action?dutys.dsid=${dutys.DSID}">
															<i class="glyphicon glyphicon-edit icon-white"></i> 修改 </a>
														<a class="btn btn-danger"
															href="chenru/deldutys.action?dutys.dsid=${dutys.DSID}">
