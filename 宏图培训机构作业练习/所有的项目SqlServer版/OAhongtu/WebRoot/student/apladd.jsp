				...
				<div id="content" class="col-lg-10 col-sm-10" style="width: 100%;">
					...
					<div class="row">
						<div class="box col-md-12">
							<div class="box-inner" style="height: 610px;">
								<div class="box-header well" data-original-title="">
									<h2>
										<i class="glyphicon glyphicon-edit"></i> 申请备用电脑
									</h2>
								...
								<div class="box-content">
									...
									<form name="frm" action="apl/apladd" method="post">
										<input type="hidden" name="apl.astuid"
											value="${student.intenid }" />
										<input type="hidden" name="apl.ashr" value="${emp.eid }">

										<h2 class="animated rubberBand" style="margin-left: 250px">
											备用电脑申请表
										</h2>
										<br />
										...
										<div class="box-content">
											...
											<div class="control-group"
												...
												<input type="text" class="form-control"
													name="apl.astarttime"  placeholder="请选择开始时间"
											...
											<div class="control-group"
												...
												<input type="text" class="form-control" name="apl.aendtime" id="end"
										...
										<div class="box-content">
											...
											<div class="control-group"
												style="height: 30px; width: 140px; display: inline-block; margin-bottom: 0; vertical-align: middle; margin-top: 0px">
												<textarea rows="10" cols="100" name="apl.aname" placeholder="请说明原因" id="kind_editor"> 
                        	</textarea>
											</div>
										</div>
										<br />
										...
										<input type="hidden" name="apl.atime" id="zhen">
									</form>
								</div>
							</div>
						</div>
