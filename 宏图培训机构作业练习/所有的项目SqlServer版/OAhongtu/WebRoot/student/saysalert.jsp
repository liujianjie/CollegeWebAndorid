						...
						<div class="box col-md-12">
							<div class="box-inner">
								...
								<div class="box-content">
									...
									<form name="frm" action="says/saysalert" method="post">
											...
											<div style="height:30px;width:150px;display: inline-block;margin-bottom: 0;vertical-align: middle;margin-left:40px;margin-top:0px">
												<select name="says.sayface" id="selectError" data-rel="chosen"  style="width:100px;">
													<c:forEach items="${student}" var="stu">
														<option value="${stu.INTENID }" ${stu.INTENID==says.sayface?"selected":""}>
															${stu.INTENNAME }
														</option>
													</c:forEach>							
												</select>
										...
										<div class="box-content">
											...
											<div style="height:30px;width:150px;display: inline-block;margin-bottom: 0;vertical-align: middle;margin-left:25px;margin-top:0px">
												<select name="says.sayempid" id="selectError" data-rel="chosen"  style="width:100px;">
													<c:forEach items="${teaches}" var="tes">
														<option value="${tes.EID }" ${tes.EID==says.sayempid?"selected":""}>
															${tes.ENAME }
														</option>
													</c:forEach>								
												</select>
										...
										<div class="box-content">
											...
											<div class="control-group"
												...
												<input type="text" name="says.saydate" class="form-control"
													 value="${says.saydate }" style="width:200px;" onclick="WdatePicker({doubleCalendar:false,dateFmt:'yyyy-MM-dd'});">											
											</div>
										</div>
										<div class="box-content">
											<label for="exampleInputEmail1">
											...
											<div class="control-group"
												style="display: inline-block; margin-bottom: 0; vertical-align: middle; margin-left: 40px; margin-top: 0px">
												<input type="text" name="says.sayscon" class="form-control" value="${says.sayscon}" 
													placeholder="请输入谈心标题" style="width:200px;">
											</div>
										</div>
