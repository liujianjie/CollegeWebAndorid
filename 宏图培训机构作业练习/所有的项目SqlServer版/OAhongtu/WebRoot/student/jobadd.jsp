					...
					<div class="row">
						<div class="box col-md-12">
							<div class="box-inner">
								...
								<div class="box-content" style="height:630px">
									
									<form name="frm" action="job/jobadd" method="post">
										...
										<div class="box-content">
											...
											<div class="control-group"
												...
												<input type="text" name="job.jobdate" class="form-control" value="<%=datea %>"  
										...
										<div class="box-content">
											...
											<div class="control-group"
												style="display: inline-block; margin-bottom: 0; vertical-align: middle; margin-left: 20px; margin-top: 0px">
												<input type="text" name="job.jobnum" class="form-control" placeholder="请输入联系电话" style="width:200px;">											
											</div>
										</div>
										<div class="box-content">
											<label for="exampleInputEmail1">
											...
											<div class="control-group"
												...
												<input type="text" name="job.jobname" class="form-control" placeholder="请输入职位" style="width:200px;">											
										...
										<div class="box-content">
											...
											<div class="control-group"
												...
												<input type="text" name="job.jobaddr" class="form-control" placeholder="请输入地理位置" style="width:200px;">											
