						...
						<div class="box col-md-12">
							<div class="box-inner">
								...
								<div class="box-content" style="height:470px">
									...
									<form name="frm" action="sbk/sbkadd" method="post">
										<div class="box-content">
											<label for="exampleInputEmail1">
												<!-- 直接从登录的学生获取 -->
												选择阅读人
											</label>
											<div style="height:30px;width:150px;display: inline-block;margin-bottom: 0;vertical-align: middle;margin-left: 16px;margin-top:0px">
											<select name="sbk.sempid" id="selectError" data-rel="chosen"  style="width:100px">
										...
										<div class="box-content" style="margin-top: 20px">
											...
											<div class="control-group"
												style="display: inline-block; margin-bottom: 0; vertical-align: middle; margin-left: 20px;">
												<input type="text" class="form-control" name="sbk.sbacktitle"
														placeholder="请输入意见标题">
											</div>
										</div>
										...
										String datea=df.format(date);
										 %>
										<input type="hidden" name="sbk.sdate" value="<%=datea %>">
										<div class="box-content">
											<div class="control-group">
