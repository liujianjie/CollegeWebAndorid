...
<script type="text/javascript">
	...
	function checkEmp(){
		...
		$.post("lcy/json!checkIsContainEmp.action",{id_year:sel_year,id_month:sel_month,empid:sel_emp},
		function(data){	
			if(data.yz_yg==1){
				alert("此员工已结算本月工资！");
			}
...
<div class="row">
    <div class="box col-md-12">
       ...
       <form action="lcy/salary_add.action" method="post">
			<div class="ch-container">

				<div>
					<select id="sel_year" name="sa.saYear">
										<option value="2016" >2016</option>	
										<option value="2015">2017</option>
										<option value="2014">2018</option>
					</select>
					年
					<select id="sel_month" name="sa.saMonth">
				...
				<table
					...
					<tr>
						...
						<td class="center" width="40%">
							<select id="sel_emp" name="sa.empid">
						...
						<td class="center">
							...
							<input onfocus="checkEmp();" id="kaohe" type="text" name="sa.kaohe"
