...
<script type="text/javascript">
	...
	function jiazai(){
		$.post("lcy/json!selectSalary2.action",{},function(data){
			list=data.salary_list;
			//alert(list.length);
			var table=$("<table>",{
	...
	function tijiao(a){
		...
		$.post("lcy/json!count_salary",{id:id,ipt_k:ipt_k,ipt1:ipt1,ipt2:ipt2,ipt3:ipt3,ipt4:ipt4,ipt5:ipt5},function(data){
