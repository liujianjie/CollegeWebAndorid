										...
										<tbody>
											<c:forEach items="${jlist}" var="j">
												<tr>
													...
													<td class="center">
														<fmt:formatDate value="${j.jstart }" pattern="yyyy-MM-dd"/>
													...
													<td class="center">
														<c:choose> 
												    		...
												    		<c:when test="${j.jstatu==2 }">
												    		 <span class="label-success label label-default">同意</span>
												    		</c:when>
												    		<c:when test="${j.jstatu==3 }">
												    		 <span class="label-danger label label-default">不同意</span>
												    		</c:when>
												    	</c:choose>
