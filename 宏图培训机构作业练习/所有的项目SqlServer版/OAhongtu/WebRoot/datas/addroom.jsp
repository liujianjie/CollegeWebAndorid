...
<html>
  ...
  <body>
   ...
   <form action="liulirong/roomadd.action" method="post">
    <div class="row">
			<div class="box col-md-12">
				<div class="box-inner" style="height:370px;">
					<div class="box-header well" data-original-title="">
						<h2>
							<i class="glyphicon glyphicon-edit"></i>添加宿舍巡查信息
						</h2>
					...
					<div class="box-content">
						...
						<div style="height:30px;width:215px;display: inline-block;margin-bottom: 0;vertical-align: middle;margin-left:0px;">
							<input type="text" name="sr.srdate" onclick="WdatePicker({doubleCalendar:false,dateFmt:'yyyy-MM-dd'});" class="form-control" style="width:190px;height:30px;" placeholder="请输入时间">
						</div>
						...
						<div style="height:30px;width:170px;display: inline-block;margin-bottom: 0;vertical-align: middle;margin-left:10px;">
							<select data-rel="chosen" name="sr.rooms" style="width:120px;">
							  <c:forEach items="${room}" var="r">
								<option value="${r.hourid }">${r.hourname }</option>
							  </c:forEach>						
							</select>
						</div>  
						...
						<div class="box-content" style="height:130px">
					       <label for="exampleInputEmail1" style="magin-bottom:18px;">	情况说明：</label>
							 <div class="control-group" style="height:30px;width:300px;display: inline-block;margin-bottom: 0;vertical-align:middle;margin-left:20px">
					            <textarea rows="9" cols="88" name="sr.srdesc" id="kind_editor"></textarea>
					         </div>
				        </div>
