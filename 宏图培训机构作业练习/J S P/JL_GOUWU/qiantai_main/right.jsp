					...
					<div id="wrap">
  						<div id="content">
							<font size="2" color="red">
								...
								<a href="goods?method=threeqtlist&id=1&moldid=1">西餐</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="goods?method=threeqtlist&id=29&moldid=1">火锅</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="goods?method=threeqtlist&id=26&moldid=9">美发</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="goods?method=threeqtlist&id=33&moldid=5">真人cs</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="goods?method=threeqtlist&id=31&moldid=5">足疗按摩</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="goods?method=threeqtlist&id=22&moldid=7">个性写真</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="goods?method=threeqtlist&id=28&moldid=8">食品</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="goods?method=threeqtlist&id=18&moldid=1">香锅烤鱼</a>&nbsp;&nbsp;&nbsp;&nbsp;
							</font>
						</div>
					</div>
				</div>
