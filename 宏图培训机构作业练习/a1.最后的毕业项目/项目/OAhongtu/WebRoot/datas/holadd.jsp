		...
		<div class="ch-container">
			<div class="row">
				...
				<div id="content" class="col-lg-10 col-sm-10" style="width: 100%;">
					...
					<form action="liulirong/exam!addhol.action" method="post">
						<div class="row">
							<div class="box col-md-12">
								<div class="box-inner" style="height: 550px;">
									<div class="box-header well" data-original-title="">
										<h2>
											<i class="glyphicon glyphicon-edit"></i> 请/休假申请
										</h2>
									...
									<div class="box-content" style="margin-left: 250px">
										<span class="animated rubberBand"
											style="font-size: 36px; color: #0080c0;"> 请/休假申请 </span>
									...
									<div class="box-content">
										...
										<div class="control-group"
											style="height: 30px; width: 280px; display: inline-block; margin-bottom: 0; vertical-align: middle; margin-left: 20px">
											<input type="text" class="form-control"
												placeholder="请输入姓名" value="${teacher.ename }" style="width: 242px;">
										</div>
										<label for="exampleInputEmail1">
											请/休假天数：
										</label>
									...
									<div class="box-content">
										...
										<div
											style="height: 30px; width: 50px; display: inline-block; margin-bottom: 0; vertical-align: middle; margin-left: 230px;">
