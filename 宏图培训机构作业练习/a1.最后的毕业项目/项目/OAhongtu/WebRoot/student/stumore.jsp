								...
								<div class="box-content">
									<table border=0 width="100%">
										...
										<tr>
											...
											<td>
												<form action="stu/stujl?intenid=${stu.intenid }" method="post">
													<button type="submit" class="btn btn-default" style="width:90px;"><b>在校记录</b></button>&nbsp;&nbsp;&nbsp;&nbsp;
												</form>
											</td>
										</tr>
										<tr>
											...
											<td>
												<form action="stu/toalert?intenid=${stu.intenid }" method="post">
										...
										<tr>
											...
											<td>
												<button type="button" class="btn btn-default" id="btn" style="width:90px;"><b>返 回 </b></button>
												<a href="stu/list?classid=${stu.classid }" id="link"></a>
