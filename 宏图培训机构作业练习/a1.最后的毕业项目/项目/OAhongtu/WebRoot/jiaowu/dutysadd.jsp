						...
						<div class="box col-md-12">
							<div class="box-inner" style="height: 500px;">
								<div class="box-header well" data-original-title="">
									<h2>
										<i class="glyphicon glyphicon-edit"></i> 添加值班记录
									</h2>

								</div>
								<div class="box-content">
									<form role="form" action="chenru/dutysadd.action?" method="post"
										id="frm">
										...
										<div class="box-content">
											...
											<div class="controls"
												...
												<input type="hidden"name="dutys.dsempid" value="${teacher.eid }">
												<input type="text" class="form-control" value="${teacher.ename }">
											</div>
										</div>
										<!-- 时间日历框 -->
										<div class="box-content">
										<b>	时 间 ：</b>
											<div class="control-group"
												...
												<input type="text" class="form-control"
													name="dutys.dstime" placeholder="请输入时间"
										...
										<div class="box-content">
											...
											<div class="form-group"
												...
												<input type="text" class="form-control"
													name="dutys.dsplace" placeholder="请输入地点">
											</div>
											</div>
										...
										<div class="box-content">
											...
											<div class="form-group"
												...
												<textarea class="autogrow" cols="100" rows="7"
													name="dutys.dspro" placeholder="本次值班情况" id="kind_editor"></textarea>
											</div>
										</div>
