                        ...
                        <ul class="sortable-list connectList agile-list">
                            <li class="warning-element">
                                ...
                                <div class="agile-detail">
                                    <a href="agile_board.jsp#" class="pull-right btn btn-xs btn-white">标签</a>
                            ...
                            <li class="success-element">
                                支持财会人员的继续培训工作。
                                <div class="agile-detail">
                                    <a href="agile_board.jsp#" class="pull-right btn btn-xs btn-white">标记</a>
                            ...
                            <li class="danger-element">
                                ...
                                <div class="agile-detail">
                                    <a href="agile_board.jsp#" class="pull-right btn btn-xs btn-primary">确定</a>
