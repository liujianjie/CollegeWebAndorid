...
<body class="gray-bg">
            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="index_submit.jsp" method="get" accept-charset="utf-8" role="form">
                            <hr>
                            <h3>测试(URL 获取)</h3>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <article class="markdown-body entry-content" itemprop="mainContentOfPage">
                            ...
                            <h1><a id="user-content-bootstrap-search-suggest" class="anchor" href="suggest.jsp#bootstrap-search-suggest" aria-hidden="true"><span class="octicon octicon-link"></span></a>Bootstrap Search Suggest</h1>
    ...
    keyEnter: 13                    //回车键
                            ...
                            <h2><a id="user-content-note-on-patches--pull-requests" class="anchor" href="suggest.jsp#note-on-patches--pull-requests" aria-hidden="true"><span class="octicon octicon-link"></span></a>Note on Patches / Pull Requests</h2>
                            ...
                            <h2><a id="user-content-设计制作" class="anchor" href="suggest.jsp#设计制作" aria-hidden="true"><span class="octicon octicon-link"></span></a>设计制作</h2>
    ...
    <script type="text/javascript">
        var testBsSuggest=$("#test").bsSuggest({url:"js/plugins/suggest/data.json",idField:"userId",keyField:"userName"}).on("onDataRequestSuccess",function(b,a){console.log("onDataRequestSuccess: ",a)}).on("onSetSelectValue",function(b,a){console.log("onSetSelectValue: ",a)}).on("onUnsetSelectValue",function(a){console.log("onUnsetSelectValue")});var testBsSuggest=$("#testNoBtn").bsSuggest({url:"js/plugins/suggest/data.json",showBtn:false,idField:"userId",keyField:"userName"}).on("onDataRequestSuccess",function(b,a){console.log("onDataRequestSuccess: ",a)}).on("onSetSelectValue",function(b,a){console.log("onSetSelectValue: ",a)}).on("onUnsetSelectValue",function(a){console.log("onUnsetSelectValue")});var testdataBsSuggest=$("#test_data").bsSuggest({indexId:2,indexKey:1,data:{"value":[{"id":"0","word":"lzw","description":"http://lzw.me"},{"id":"1","word":"lzwme","description":"http://w.lzw.me"},{"id":"2","word":"meizu","description":"http://www.meizu.com"},{"id":"3","word":"flyme","description":"http://flyme.meizu.com"}],"defaults":"http://lzw.me"}});var baiduBsSuggest=$("#baidu").bsSuggest({allowNoKeyword:false,multiWord:true,separator:",",getDataMethod:"url",url:"http://unionsug.baidu.com/su?p=3&t="+(new Date()).getTime()+"&wd=",jsonp:"cb",processData:function(c){var b,a,d={value:[]};if(!c||!c.s||c.s.length===0){return false}console.log(c);a=c.s.length;jsonStr="{'value':[";for(b=0;b<a;b++){d.value.push({word:c.s[b]})}d.defaults="baidu";return d}});var taobaoBsSuggest=$("#taobao").bsSuggest({indexId:2,indexKey:1,allowNoKeyword:false,multiWord:true,separator:",",getDataMethod:"url",effectiveFieldsAlias:{Id:"序号",Keyword:"关键字",Count:"数量"},showHeader:true,url:"http://suggest.taobao.com/sug?code=utf-8&extras=1&q=",jsonp:"callback",processData:function(c){var b,a,d={value:[]};if(!c||!c.result||c.result.length==0){return false}console.log(c);a=c.result.length;for(b=0;b<a;b++){d.value.push({"Id":(b+1),"Keyword":c.result[b][0],"Count":c.result[b][1]})}console.log(d);return d}});$("form").submit(function(a){return false});
    </script>
</body>
