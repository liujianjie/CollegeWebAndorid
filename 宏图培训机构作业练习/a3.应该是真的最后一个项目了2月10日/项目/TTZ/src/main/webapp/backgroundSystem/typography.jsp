                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="typography.jsp#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="typography.jsp#">选项1</a>
                                </li>
                                <li><a href="typography.jsp#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="list-group">
                            <a class="list-group-item active" href="typography.jsp#">
                            ...
                            <a class="list-group-item" href="typography.jsp#">
