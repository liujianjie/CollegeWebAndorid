                            ...
                            <div class="col-md-9 ">
                                <div class="chat-discussion">
                                    ...
                                    <div class="chat-message">
                                        ...
                                        <div class="message">
                                            <a class="message-author" href="chat_view.jsp#"> 颜文字君</a>
                                    ...
                                    <div class="chat-message">
                                        ...
                                        <div class="message">
                                            <a class="message-author" href="chat_view.jsp#"> 林依晨Ariel </a>
                                    ...
                                    <div class="chat-message">
                                        ...
                                        <div class="message">
                                            <a class="message-author" href="chat_view.jsp#"> 谨斯里 </a>
                                            <span class="message-date">  2015-02-02 11:12:36 </span>
                                            <span class="message-content">
                                    ...
                                    <div class="users-list">
                                        <div class="chat-user">
                                            ...
                                            <div class="chat-user-name">
                                                <a href="chat_view.jsp#">伤城Simple</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            <img class="chat-avatar" src="img/a1.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="chat_view.jsp#">从未出现过的风景__</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                        ...
                                        <div class="chat-user">
                                            ...
                                            <div class="chat-user-name">
                                                <a href="chat_view.jsp#">ZM敏姑娘	</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            <img class="chat-avatar" src="img/a5.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="chat_view.jsp#">才越越</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            <img class="chat-avatar" src="img/a6.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="chat_view.jsp#">时光十年TENSHI</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            <img class="chat-avatar" src="img/a2.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="chat_view.jsp#">刘顰颖</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            <span class="pull-right label label-primary">在线</span>
                                            <img class="chat-avatar" src="img/a3.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="chat_view.jsp#">陈泳儿SccBaby</a>
                                            </div>
                                        </div>
