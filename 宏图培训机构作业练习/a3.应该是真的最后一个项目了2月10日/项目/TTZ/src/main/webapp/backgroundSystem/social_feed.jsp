<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">TYPE html>
<html>
                ...
                <div class="social-feed-box">
                    ...
                    <div class="pull-right social-action dropdown">
                        ...
                        <ul class="dropdown-menu m-t-xs">
                            <li><a href="social_feed.jsp#">设置</a></li>
                        </ul>
                    </div>
                    <div class="social-avatar">
                        <a href="social_feed.jsp" class="pull-left">
                            <img alt="image" src="img/a1.jpg">
                        </a>
                        <div class="media-body">
                            <a href="social_feed.jsp#">
                                        尤小右
                                    </a>
                    ...
                    <div class="social-footer">
                        <div class="social-comment">
                            ...
                            <div class="media-body">
                                ...
                                <br/>
                                <a href="social_feed.jsp#" class="small"><i class="fa fa-thumbs-up"></i> 26</a> -
                        ...
                        <div class="social-comment">
                            ...
                            <div class="media-body">
                                ...
                                <br/>
                                <a href="social_feed.jsp#" class="small"><i class="fa fa-thumbs-up"></i> 11</a> -
                                <small class="text-muted">8月18日</small>
                            </div>
                        </div>
