		...
		<div id="page-wrapper" class="gray-bg">
			<div class="row border-bottom white-bg">
				...
				<div class="navbar-header">
					...
					<a href="index_v5.jsp#" class="navbar-brand">Hplus</a>
				</div>
				<div class="navbar-collapse collapse" id="navbar">
					<ul class="nav navbar-nav">
						<li class="active"><a aria-expanded="false" role="button"
							href="index.jsp"> 返回首页</a></li>
						<li class="dropdown"><a aria-expanded="false" role="button"
							href="index_v5.jsp#" class="dropdown-toggle"
							data-toggle="dropdown"> 菜单 <span class="caret"></span></a>
							<ul role="menu" class="dropdown-menu">
								<li><a href="index_v5.jsp">菜单列表</a></li>
								<li><a href="index_v5.jsp">菜单列表</a></li>
								<li><a href="index_v5.jsp">菜单列表</a></li>
								<li><a href="index_v5.jsp">菜单列表</a></li>
							</ul></li>
						<li class="dropdown"><a aria-expanded="false" role="button"
							...
							<ul role="menu" class="dropdown-menu">
								...
								<li><a href="index_v5.jsp">菜单列表</a></li>
								<li><a href="index_v5.jsp">菜单列表</a></li>
								<li><a href="index_v5.jsp">M菜单列表</a></li>
							</ul></li>
						<li class="dropdown"><a aria-expanded="false" role="button"
							href="index_v5.jsp#" class="dropdown-toggle"
							data-toggle="dropdown"> 菜单 <span class="caret"></span></a>
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="font-bold text-navy">
												44% <i class="fa fa-level-up"></i> <small>增长较快</small>
											</div>
										</div>
										<div class="col-md-6">
											<h1 class="no-margins">206,120</h1>
											<div class="font-bold text-navy">
												22% <i class="fa fa-level-up"></i> <small>增长较慢</small>
											</div>
										</div>
									</div>
					...
					<div class="row">
						<div class="col-lg-8">
							<div class="ibox float-e-margins">
								<div class="ibox-content">
									<div>
										<span class="pull-right text-right"> <small>在过去的一个月销售的平均值：<strong>山东</strong></small>
											<br /> 所有销售： 162,862
										</span>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<ul class="stat-list m-t-lg">
													<li>
														<h2 class="no-margins">2,346</h2> <small>总订单</small>
									...
									<div class="m-t-md">
										...
										</small> <small> <strong>说明：</strong> 本期销售额比上期增长了23%。
										</small>
									</div>
								...
								<div class="ibox-title">
									...
									<div class="ibox-tools">
										<a class="collapse-link"> <i class="fa fa-chevron-up"></i>
											...
											href="index_v5.jsp#"> <i class="fa fa-wrench"></i>
										</a>
										<ul class="dropdown-menu dropdown-user">
											<li><a href="index_v5.jsp#">设置选项1</a></li>
											<li><a href="index_v5.jsp#">设置选项2</a></li>
										</ul>
			...
			<div class="footer">
				<div class="pull-right">
					By：<a href="../../index.jsp" target="_blank">zihan's blog</a>
				</div>
				<div>
		...
		$(document)
				.ready(
						function() {
							...
							var b = document.getElementById("lineChart")
									.getContext("2d");
							var c = new Chart(b).Line(g, d)
						});
	</script>
