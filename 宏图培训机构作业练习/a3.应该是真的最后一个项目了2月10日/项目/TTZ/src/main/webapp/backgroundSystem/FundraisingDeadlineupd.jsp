			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form action="${pageContext.request.contextPath}/updFun.action" method="post">
						<input type="hidden" name="fid" value="${f.fid }"/>
							借款期限:<input type="text" name="jiekuantime" value="${f.jiekuantime }" /> 筹款期限:<input
								type="text" name="choukuantime" value="${f.choukuantime }" /> <input type="submit"
								value="修改" />
						</form>
					</div>
				</div>
