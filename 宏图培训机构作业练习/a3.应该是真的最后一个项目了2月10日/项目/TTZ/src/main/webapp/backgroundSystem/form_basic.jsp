                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p>您可以注册一个新账户</p>
                                <p class="text-center">
                                    <a href="form_basic.jsp"><i class="fa fa-sign-in big-icon"></i></a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="text-center">
                            <a data-toggle="modal" class="btn btn-primary" href="form_basic.jsp#modal-form">打开登录窗口</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="input-group m-b">
                                        <div class="input-group-btn">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="form_basic.jsp#">选项3</a>
                                                </li>
                                                <li class="divider"></li>
                                                <li><a href="form_basic.jsp#">选项4</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <input type="text" class="form-control">
