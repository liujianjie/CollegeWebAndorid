...
public interface TenderRecordDao {
	...
	public int TenderRecordEarnings();// 收益中利息

	public int TenderRecordPoundage();// 手续费

	public int TenderRecordZhong(); // 中标数 、投标数

	public int TenderRecordSum();// 已完成投资金额

	public List SelHuiKuan(Map<String, Object> map);// 查询回款记录

	public int SelHuiKuanCount(Map<String, Object> map);// 查询条数
