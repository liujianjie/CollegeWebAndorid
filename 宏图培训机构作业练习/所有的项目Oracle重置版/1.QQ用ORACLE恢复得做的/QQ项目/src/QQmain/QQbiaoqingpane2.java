...
public class QQbiaoqingpane2 extends JFrame implements FocusListener{
	// 图片数组
	Icon bqs[] = new ImageIcon[10];
	JLabel bq[] = new JLabel[10];
	JLabel pane1,pane2,pane3;
	JPanel p1;
	QQchat chat;
	public QQbiaoqingpane2(QQchat chat) {
		super();
		//设置组件样式
		try {
		...
		// 表情
		for (int i = 1; i <= 9; i++) {
			bqs[i] = new ImageIcon("3911/" + i + ".jpg");
		}
		// 面板
		p1 = new JPanel();
