...
public interface QQuserInterface {
	...
	public boolean addQqgame(QQgame g);//游戏信息添加到数据库
	...
	public void addscore(String qqnum,int score);//改变贪吃蛇的分数

	public boolean chekhui(String qqnum);//是不是会员
	
	public QQgame shenode(String qqnum);//查询蛇节
	
	public boolean updshenode(String qqnum,int node,int shetoux0,int shetouy0,int shetoux1,int shetouy1,int foodx,int foody,int direction);//改变蛇节和蛇头坐标
