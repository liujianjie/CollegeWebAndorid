...
public class dzgame extends JFrame implements Runnable {
JPanel contentPane;
...
private dzgame adaptee;

Frame1_jButton2_actionAdapter(dzgame adaptee) {
...
Frame1_jButton1_actionAdapter(dzgame adaptee) {
   this.adaptee = adaptee;
}
