...
<body class="gray-bg">
            ...
            <div class="col-sm-9 animated fadeInRight">
                <div class="mail-box-header">
                    ...
                    <div class="mail-tools tooltip-demo m-t-md">
                        ...
                        <button onclick="javasrcipt:location.href='findpagemsglist.do'" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" title="刷新通知列表"><i class="fa fa-refresh"></i> 刷新</button>
    ...
    <script type="text/javascript">
		function userlist(btn) {
			...
			if (id == "btn1" || id == "btn4") {
				location.href = "findpagemsglist.do?cpage=" + (currPage - 1)+ "&v=0";
			} else if (id == "btn2") {
				location.href = "findpagemsglist.do?cpage=" + (currPage - 3)+ "&v=0";
			} else if (id == "btn3") {
				location.href = "findpagemsglist.do?cpage=" + (currPage - 2)+ "&v=0";
			} else if (id == "btn5") {
				location.href = "findpagemsglist.do?cpage=" + (currPage)+ "&v=0";
			} else if (id == "btn7") {
				location.href = "findpagemsglist.do?cpage=" + (currPage + 2)+ "&v=0";
			} else if (id == "btn8") {
				location.href = "findpagemsglist.do?cpage=" + (currPage + 3)+ "&v=0";
