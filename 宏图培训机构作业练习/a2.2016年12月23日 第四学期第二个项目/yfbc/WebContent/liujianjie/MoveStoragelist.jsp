...
<body class="gray-bg">
							...
							<tbody id = "tbody">
								<c:forEach items="${maps.movelist }" var="move" varStatus="var">
									<tr height="50">
										...
										<td>
											<c:if test="${move.mostate==0 }">
												<a href="${pageContext.request.contextPath}/movestorage/update.do?id=${move.moid}"
	...
	<script>
		...
		function userlist(btn) {
			...
			if(id=="btn1"||id=="btn4"){
				location.href="list.do?cpage="+(currPage-1)+"&userid="+userid+"&v=0";
			}else if(id=="btn2"){
				location.href="list.do?cpage="+(currPage-3)+"&userid="+userid+"&v=0";
			}else if(id=="btn3"){
				location.href="list.do?cpage="+(currPage-2)+"&userid="+userid+"&v=0";
			}else if(id=="btn5"){
				location.href="list.do?cpage="+(currPage)+"&userid="+userid+"&v=0";
			}else if(id=="btn7"){
				location.href="list.do?cpage="+(currPage+2)+"&userid="+userid+"&v=0";
			}else if(id=="btn8"){
				location.href="list.do?cpage="+(currPage+3)+"&userid="+userid+"&v=0";
