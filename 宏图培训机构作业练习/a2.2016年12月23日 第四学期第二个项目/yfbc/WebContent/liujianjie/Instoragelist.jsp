...
<body class="gray-bg">
                                    ...
                                    <td>
                                    	<c:forEach items="${maps.warelist }" var="ware">
                                    		<c:if test="${ware.whid==in.whid }">
												${ware.whiname } 
												<input id="${var.index+1 }whiname" type="text" style="display:none " value="${ware.whiname } ">                                   		
                                    		</c:if>
                                    	</c:forEach>
                                    	<!-- 供应商号码 收货人号码  状态 单位-->
	...
	<script>
		function inlist(){
			...
			location.href="listofwhere.do?cpage=1&starttime="+starttime+"&endtime="+endtime+"&whid="+whid+"";
		}
	</script>
	...
	<script>
		function userlist(btn) {
			...
			if(id=="btn1"||id=="btn4"){
				location.href="listofwhere.do?cpage="+(currPage-1)+"&starttime="+starttime+"&endtime="+endtime+"&whid="+whid+"&v=0";
			}else if(id=="btn2"){
				location.href="listofwhere.do?cpage="+(currPage-3)+"&starttime="+starttime+"&endtime="+endtime+"&whid="+whid+"&v=0";
			}else if(id=="btn3"){
				location.href="listofwhere.do?cpage="+(currPage-2)+"&starttime="+starttime+"&endtime="+endtime+"&whid="+whid+"&v=0";
			}else if(id=="btn5"){
				location.href="listofwhere.do?cpage="+(currPage)+"&starttime="+starttime+"&endtime="+endtime+"&whid="+whid+"&v=0";
			}else if(id=="btn7"){
				location.href="listofwhere.do?cpage="+(currPage+2)+"&starttime="+starttime+"&endtime="+endtime+"&whid="+whid+"&v=0";
			}else if(id=="btn8"){
				location.href="listofwhere.do?cpage="+(currPage+3)+"&starttime="+starttime+"&endtime="+endtime+"&whid="+whid+"&v=0";
