			...
			<div class="col-sm-8">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<form action="upd.do"   method="post" class="form-horizontal m-t">
							...
							<div class="form-group draggable">
								...
								<div class="col-sm-9">
										<input type="text" class="form-control" name="msgtopeople" value="${msg.msgtopeople }"
									>
								</div>s
							</div>
							...
							<div class="form-group draggable">
								...
								<div class="col-sm-9">
									<input onclick="WdatePicker();" type="text" class="form-control" name="msgtime" value="${msg.msgtime}"
										 readonly="readonly"
>
								</div>
							</div>
