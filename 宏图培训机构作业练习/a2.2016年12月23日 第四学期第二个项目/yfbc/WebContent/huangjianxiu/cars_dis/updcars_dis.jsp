				...
				<div class="col-sm-8">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<form class="form-horizontal m-t" id="signupForm" action="updcars_dis.do" method="post" >
								<div class="form-group">
								 <input type="hidden" value="${cars_dis.id }" name="id"/>
									<label class="col-sm-3 control-label">仓库：</label>
									<div class="col-sm-6">
									<input type="hidden" value="${cars_dis.warehouseid }" name="warehouseid"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
									<input type="hidden" value="${cars_dis.carsid }" name="carsid" />
									<input  class="form-control"
											type="text" value="${carsname }" readonly="readonly"> <span class="help-block m-b-none"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
									 <select class="form-control m-b" name="userid" >
									 	<c:forEach items="${userlist }" var="user">
	                                        	<option value="${user.id }"${cars_dis.userid == user.id ?'selected':''}>${user.username }</option>
	                                	</c:forEach>
                                   		 </select>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input id="distributiondate" name="distributiondate" class="form-control"
											onclick="WdatePicker();" value="<fmt:formatDate value="${cars_dis.distributiondate}" pattern="YYYY-MM-dd"/>"
