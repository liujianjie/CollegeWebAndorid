...
<body class="gray-bg">
				...
				<div class="col-sm-8">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<form class="form-horizontal m-t" id="signupForm" action="addcars_dis.do" method="post" >
	...
	<script type="text/javascript">
		function showcars() {
			...
			$.post("cars.do",{"warehouseid":warehouseid,"positionid":positionid},function(result){
				//查询车辆类型
				var carslist = result.carslist;
				var str = "<select class='form-control m-b' name='carsids' ><option>--请选择车辆--</option>";
				...
				var str = "<select class='form-control m-b' name='userid' ><option>--请选择配送员--</option>";
