				...
				<div class="col-sm-8">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<form class="form-horizontal m-t" id="signupForm" action="updcars_att.do" method="post" >
							<input type="hidden" name="id" value="${cars_att.id }">
								<div class="form-group">
									<label class="col-sm-3 control-label">仓库：</label>
									<div class="col-sm-6">
									<input type="hidden" value="${cars_att.warehouseid }" name="warehouseid"/>
										<input  class="form-control"
											type="text" value="${whname }" readonly="readonly"> <span class="help-block m-b-none"></span>	
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
									<input type="hidden" value="${cars_att.carsid }" name="carsid" />
									<input  class="form-control"
											type="text" value="${carname }" readonly="readonly"> <span class="help-block m-b-none"></span>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">车辆配送员：</label>
									<div class="col-sm-6">
									<input type="hidden" value="${cars_att.userid }" name="userid" />
									<input  class="form-control"
											type="text" value="${drivername }" readonly="readonly"> <span class="help-block m-b-none"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										 ...
										 <option></option>
										 	<c:forEach items="${outinnos }" var="outinno">
	                                        	<option value="${outinno.inno }"${cars_att.inno == outinno.inno ?'selected':'' }>${outinno.inno }</option>
	                                        </c:forEach>
                                   		 </select>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input id="carsstartdate" name="carsstartdate" class="form-control"
											onclick="WdatePicker();"  value="<fmt:formatDate value="${cars_att.carsstartdate}" pattern="YYYY-MM-dd"/>"
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input id="carsarrivedate" name="carsarrivedate" class="form-control"
											onclick="WdatePicker();" value="<fmt:formatDate value="${cars_att.carsarrivedate}" pattern="YYYY-MM-dd"/>"
											type="text" readonly="readonly"aria-required="true" aria-invalid="false"
											class="valid">
									</div>
								</div>
