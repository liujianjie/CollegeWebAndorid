				...
				<div class="col-sm-8">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<form class="form-horizontal m-t" id="signupForm" action="addincome.do" 
								method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input id="inctime" name="inctime" class="form-control"
											...
											type="text" readonly="readonly" aria-required="true"
											aria-invalid="false">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6" id="types"><input id="types" name="types" type="text" class="form-control"></div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">收入金额：</label>
									<div class="col-sm-6" id="money"><input id="money" name="money" type="text" class="form-control"></div>
								</div>
