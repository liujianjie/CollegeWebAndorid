				...
				<div class="col-sm-8">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<form class="form-horizontal m-t" id="signupForm" action="addexpend.do" method="post" >
								
								<div class="form-group">
									<label class="col-sm-3 control-label">支出时间：</label>
									<div class="col-sm-6">
										<input id="exptime" name="exptime" class="form-control"
								...
								<div class="form-group">
									...
									<div class="col-sm-6" id="exptypes">
										 <input id=exptypes name="exptypes" type="text" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">支出金额：</label>
									<div class="col-sm-6" id="money">
