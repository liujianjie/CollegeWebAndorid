...
<body class="gray-bg">
	<div class="wrapper wrapper-content animated fadeInRight">
		<button type="button" class="btn btn-primary dim"
			onclick="location.href='${pageContext.request.contextPath}/expend/toaddexpend.do'">添加支出信息</button>
		<div class="row">
					...
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							...
							<table class="footable table table-stripped" data-page-size="8"
								...
								<tbody>
									<c:forEach items="${expends}" var="expend">
										<tr class="gradeA">

											<td><fmt:formatDate value="${expend.exptime}"
													pattern="yyyy-MM-dd" /></td>
											<td>${expend.exptypes}</td>
											<td>${expend.money}</td>

											<td><a class="collapse-link" href="del.do?id=${expend.id }">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
									...
									<tr>
										<td colspan="5">
											...
											<div class="btn-group col-sm-8">
												...
												<div class="col-sm-2">
													<input type="text" id="pageCount" value="${pageCount }"
														class="form-control" />
												</div>
												<a><button type="button" id="btn1"
	...
	<script>
		function cars_dislist(btn) {
			...
			if (id == "btn1" || id == "btn4") {
				location.href = "expendlist.do?pageCount=" + pageCount
						+ "&currPage=" + (currPage - 1) + "&v=0";
			} else if (id == "btn2") {
				location.href = "expendlist.do?pageCount=" + pageCount
						+ "&currPage=" + (currPage - 3) + "&v=0";
			} else if (id == "btn3") {
				location.href = "expendlist.do?pageCount=" + pageCount
						+ "&currPage=" + (currPage - 2) + "&v=0";
			} else if (id == "btn5") {
				location.href = "expendlist.do?pageCount=" + pageCount
						+ "&currPage=" + (currPage) + "&v=0";
			} else if (id == "btn7") {
				location.href = "expendlist.do?pageCount=" + pageCount
						+ "&currPage=" + (currPage + 2) + "&v=0";
			} else if (id == "btn8") {
