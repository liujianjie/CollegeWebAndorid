...
//		mp3sound = new TetrisMp3("Jackal - Animal Style.mp3");
		...
		a.add(jpanelbgimg);// 添加标签背景图片 要求6
	...
	public static void main(String[] args) {
		...
		// 要求1.背景音乐循环播放。 用了第三方包，具体代码我也不清楚，mp3文件使用起来比较麻烦，可以mp3转wav文件，再用audio包下的类循环播放wav文件即可
		// 第三方包 循环播放使用了线程，更随主程序的消亡而停止 下载地址http://www.javazoom.net/mp3spi/sources.html，MP3spl支持
		mp3sound.loop();
	}
}
