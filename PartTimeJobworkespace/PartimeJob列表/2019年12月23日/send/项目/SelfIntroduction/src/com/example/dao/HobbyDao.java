...
public class HobbyDao {
	...
	public List<HobbyBean> getDefaultHobbyList(){
		...
		hoblist.add(hob);
		hob = new HobbyBean(11, "画画");
		hoblist.add(hob);
		hob = new HobbyBean(12, "养花");
		hoblist.add(hob);
		hob = new HobbyBean(13, "旅游");
		hoblist.add(hob);
		hob = new HobbyBean(14, "唱歌");
		hoblist.add(hob);
		hob = new HobbyBean(15, "跳舞");
		hoblist.add(hob);
		hob = new HobbyBean(16, "弹琴");
		hoblist.add(hob);
		hob = new HobbyBean(17, "滑板");
		hoblist.add(hob);
		hob = new HobbyBean(18, "跑步");
		hoblist.add(hob);
		hob = new HobbyBean(19, "钢琴");
		hoblist.add(hob);
		return hoblist;
	}
	// 添加数据
