	  	 ...
	  	 <form  id="repertory" method="post">
	  		...
	  		<table class="table table-striped"  >
	  			<tr>
	  				...
	  				<td>
	  					出库日期<span>${map2.date }<%-- <input type="text" value="${map2.date}" name="date" readonly="readonly"/> --%></span>
	  				</td>
	  				<td>
	  					出库编号<span>${map2.listid }<%-- <input type="text" value="${map2.listid}" name="empid" readonly="readonly"/> --%></span>
	  				</td>
	  				<td>
