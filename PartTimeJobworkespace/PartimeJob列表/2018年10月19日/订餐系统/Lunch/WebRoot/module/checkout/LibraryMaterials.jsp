	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("#addBtn").click(function(){
				...
				alert(aaa);
				$.ajax({
					url:"${path }/library_updateAllLibraryMaterials.action",
					data:{"caterials":JSON.stringify(aaa),warehouseid:$("#warehouseid").val()},
					type:"post",
					dataType:"json",
					success:function(data){
						alert(data.message);
						window.location.href="${path}/library_findLibraryMaterials.action";
					}
				}); 
			});
	  		...
	  		<table class="table table-striped"  >
	  			<tr>
	  				<%-- <td>${map }
	  				    ...
	  				    <input type="hidden" value="${map.warehouse_id}" id="warehouseid" name="warehouseid"/>
	  				<td>
