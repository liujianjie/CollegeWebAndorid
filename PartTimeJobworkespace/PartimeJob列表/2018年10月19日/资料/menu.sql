...
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES ('1', '好吃', '1', '1');
...
CREATE TABLE `level` (
  ...
  `level_url` varchar(255) NOT NULL,
  `level_point` varchar(255) NOT NULL,
...
CREATE TABLE `staff` (
  ...
  KEY `fk_staff_detail_id` (`staff_detail_id`),
  CONSTRAINT `fk_staff_detail_id` FOREIGN KEY (`staff_detail_id`) REFERENCES `staff_detail` (`staff_detail_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
