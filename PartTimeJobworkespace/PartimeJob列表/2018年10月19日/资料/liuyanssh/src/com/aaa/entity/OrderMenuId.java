...
public class OrderMenuId implements java.io.Serializable {
	...
	/** full constructor */
	public OrderMenuId(Menu menu, OutOrder outOrder) {
		this.menu = menu;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OrderMenuId))
			return false;
		OrderMenuId castOther = (OrderMenuId) other;
