...
<div class="treebox">
		<ul class="menu">
			<li class="level1">
				...
				<ul class="level2">
					<li><a href="comment.jsp" target="main">评论管理</a></li>
					<li><a href="count.jsp" target="main">统计管理</a></li>
					
				</ul>
			</li>
			<li class="level1">
				<a href="#none"><em class="ico ico2"></em>考试成绩查询<i></i></a>
				<ul class="level2">
					<li><a href="javascript:;">考试查询</a></li>
					<li><a href="javascript:;">成绩查询</a></li>
					<li><a href="javascript:;">班级排名</a></li>
				</ul>
			</li>  
		</ul>
	</div>
