...
<body>
	<div class="container">
        ...
        <div class="content">
			...
			<form action="systemuser?method=update" method="post" onsubmit="return checkForm();">
			<table width="850px" border="0" cellspacing="0">
				<tr>
					<td style="padding: 30px"  ><h1>用户修改</h1>
						<table width="79%" height="350px" border="0" cellspacing="2" class="upline"  bgcolor="white">
							<tr>
								<td width="21%" style="text-align: right">姓名：
							...
							<tr>
								...
								<td><input type="password" class="textinput"  id="password" name="password" onkeyup="checkPassword();" value="${systemuser.userPassword }"/></td>
								<td width="46%"><span id="passwordMsg"></span><font color="#262626">密码请设置6-16位字符</font></td>
							</tr>
							<tr>
								<td style="text-align: right">重复密码：</td>
								<td>
								<input type="password" class="textinput"  id="repassword" name="repassword" onkeyup="checkConfirm();" value="${systemuser.userPassword }"/>
								</td>
