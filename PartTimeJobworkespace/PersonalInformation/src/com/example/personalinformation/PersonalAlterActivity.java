...
import com.example.adpter.PersonalAlterBaseAdapter2;
...
// 个人信息修改activity
public class PersonalAlterActivity extends Activity {
	private TextView title;
	EditText titletext,contexttext;
	
	PersonalAlterBaseAdapter2 perbase;
	...
	private void inAdater() {
		if (perlist != null) {
			perbase = new PersonalAlterBaseAdapter2(this);
