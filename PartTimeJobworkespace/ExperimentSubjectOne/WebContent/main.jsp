...
<!-- 2.首页轮播图  start -->
	<div id="box_autoplay">
    	<div class="list">
        	<ul>
            	<li><img src="images/3.jpg" width="900" height="500px" /></li>
                <li><img src="images/2.jpg" width="900" height="500px" /></li>
            	<li><img src="images/4.jpg" width="900" height="500px" /></li>
        	</ul>
    	</div>
	</div>
	<!-- 2.首页轮播图  end -->
