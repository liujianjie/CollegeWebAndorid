...
<html>
  ...
  <body>
  <form id="form1" action="goods?method=alertnoimg" method="post" name="frm" onsubmit="return submit_form();">
  <input type="hidden" value="${goods.g_id }" name="id"> 
    		...
    		<tr align="center">
    			...
    			<td align="left" >
    				...
    				<img src="file/${goods.g_img }" id="showimg"  height="150" width="165">
    					<br>
    				<input type="file" id="photo_file" name="img" size="55" onchange="chooseFile(this);">
    			</td>
    		</tr>
    		<tr align="center" height="30">
    			<td width="250">
  	...
  	function submit_form(){
  		...
  		if(choicefile.value == ""){
  			...
  			document.getElementById("form1").action = "goods?method=alertnoimg"
  		}
  		// 2.若上传了新文件
  		if(choicefile.value != ""){
  			document.getElementById("form1").encoding = "multipart/form-data";
  			document.getElementById("form1").action = "goods?method=alertwithimg";
  		}
  		return true;
  	}
  	</script>
