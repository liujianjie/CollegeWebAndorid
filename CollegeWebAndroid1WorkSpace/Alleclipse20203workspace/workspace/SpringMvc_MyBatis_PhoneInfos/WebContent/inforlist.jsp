	...
	<table width="70%" align="center" cellspacing="1.5" bgcolor="#00ff00" >
		...
		<c:forEach items="${inforlist }" var="infor">
			...
			<tr align="center" bgcolor="#ffffff" height="30">
				...
				<td><a href="${pageContext.request.contextPath }/selxq.do?inforid=${infor.inInforid }">${infor.inTitle }</a></td>
				<td>${infor.inReplycount }/${infor.inViewcount }</td>
				<td>
					<fmt:formatDate value="${infor.inReporttime }" pattern="yyyy-mm-dd hh:mm:ss"/>
				</td>
				<td><fmt:formatDate value="${infor.inLastposttime }" pattern="yyyy-mm-dd hh:mm:ss"/></td>
			</tr>
		</c:forEach>
	</table>
</body>
