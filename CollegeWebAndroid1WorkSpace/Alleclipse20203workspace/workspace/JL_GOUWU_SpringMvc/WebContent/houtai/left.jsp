    ...
    <table width="70%" align="right">
    	<tr align="center" height="50">
    		<td>
    				...
    				<div id="wrap">
  					<div id="content">
  						<a href="mold/htlist" target="main">类型信息</a>
  					</div>
  					</div>
  					</div>
  		...
  		<tr align="center" height="50">
  			<td>
  				...
  				<div id="wrap">
  				<div id="content">
   					<a href="bottom/list" target="main">分类信息</a>
   				</div>
  				</div>
    			</div>
  			</td>
  		...
  		<tr align="center" height="50" valign="middle">
  			<td >
  				...
  				<div id="wrap">
  				<div id="content">
    				<a href="bottom/toadd" target="main">添加分类</a>
    			</div>
  				</div>
    			</div>
  			</td>
  		...
  		<tr align="center" height="50">
  			<td>
  				...
  				<div id="wrap">
  				<div id="content">
    				<a href="goods/list" target="main">商品信息</a>
    			</div>
  				</div>
    			</div>
  			</td>
  		...
  		<tr align="center" height="50">
  			<td>
  				...
  				<div id="wrap">
  				<div id="content">
    				<a href="goods/toadd" target="main">添加商品</a>
    			</div>
  				</div>
    			</div>
  			</td>
