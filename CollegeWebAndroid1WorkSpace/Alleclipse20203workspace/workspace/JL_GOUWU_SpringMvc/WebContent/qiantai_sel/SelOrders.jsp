			    ...
			    <table width="100%" align="center" border=0 cellpadding="0" cellspacing="0" bgcolor="#6B6068"><!-- 汤姆的颜色 -->
			    	...
			    	<c:forEach items="${orderslist}" var="order">
			    		<tr bgcolor="#bfbfbf" height="30">
			    			...
			    			<td align="center">
			    				...
			    				<c:if test="${order.statu eq 2}">
			    					已使用<a href="goods/goodsxq?id=${order.g_id }"><font color="#008080" >去评价</font></a>
			    				</c:if>
			    			</td>
			    		</tr>
			    		...
			    		<tr height="90" bgcolor="white">
							...
							<td align="center"><a href="goods/goodsxq?id=${order.g_id }"><font color="#008080" >查看详情</font></a></td>
			    		</tr>
						<!-- 来一条横线 -->
			    	...
			    	<tr bgcolor="white" height="30">
						<td colspan="5">
							<font color="#008080">
			    			<a href="index/selorders?currp=1">首页</a>	
			    			<a href="index/selorders?currp=${currPage-1 }">上一页</a>
		
					    	<c:forEach begin="${currPage}" end="${currPage+2}" var="i" step="1">
					   			<c:if test="${i<=totalPage}">
					    			<a href="index/selorders?currp=${i }">${i }</a>
					    		</c:if>
					    	</c:forEach>
			    			<a href="index/selorders?currp=${currPage+1}">下一页</a>	
			    			<a href="index/selorders?currp=${totalPage}">尾页</a>
    ...
    <script>
	    	function fangfa(){
	    		...
	    		if(isNaN(page)){
	    			...
	    			location.href="index/selorders?currp="+page;
	    		}
	    	}
    	</script>
