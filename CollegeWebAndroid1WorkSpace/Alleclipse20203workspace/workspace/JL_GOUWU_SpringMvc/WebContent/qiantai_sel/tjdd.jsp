	...
	<div class="soubg">
		<div class="sou">
			<span class="s_city_b">
				...
				<c:if test="${jruser!=null }">
					<span class="s_city">
						<span>欢迎您,亲爱的<font color="red">${jruser.uname  }</font>&nbsp;<a href="goods/deljruser" target="_top">退出</a></span>
					</span>
				</c:if>
			</span>
			<span class="fr s_rightpadding">
				<span class="fl">
					...
					<c:if test="${jruser!=null}">
						<a href="goods/selorders" target="_top">我的订单</a>
					</c:if>
					<c:if test="${jruser==null}">
		    ...
		    <table width="100%" align="center" border=0 cellpadding="0" cellspacing="0" bgcolor="DarkOrange"><!-- 橙红 -->
		    	...
		    	<c:forEach items="${gwcgoods}" var="goods">
		    		<tr height="90" bgcolor="white">
						...
						<td align="center"><a href="goods/delgwcgoods?id=${goods.g_id }"><font color="#008080">删除</font></a></td>
		   	...
		   	<table width="100%" align="center">
		   		<tr>
		   			...
		   			<td width="10%"align="center">
						<a href="index/saveorders?gid=${g_id }"><img src="image/ljgm.png"></a><!-- 保存订单 -->
					</td>
		   		</tr>
		   	</table>
		</div>
