	...
	<table width="100%" cellpadding="0" cellspacing="0"
		...
		<c:forEach items="${books}" var="book">
			...
			<tr align="center">
				...
				<td>${book.price}</td>
				<td>
					<a href="${pageContext.request.contextPath}/GoodSearchByIdServlet?id=${book.id}">
					<img src="${pageContext.request.contextPath}/images/i_edit.gif">
					</a>
					<a href="${pageContext.request.contextPath}/BookDeleServlet?id=${book.id}" onclick="return confirm('确定删除吗？')">
