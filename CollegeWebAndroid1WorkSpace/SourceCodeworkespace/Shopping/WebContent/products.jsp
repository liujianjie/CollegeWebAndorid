...
<%@page import="com.zuxia.model.SalesGoods"%>
			...
			<div id="middle_left_div">
				<div id="paihang">
					...
					<table>
						...
						<tr>
							<td class="goods_<%=i%>">
								<a target="_top" href="product.jsp?id=<%=salesGoods.getGoodsId()%>">
									<%=StringUtil.omitString(salesGoods.getGoodsName(),20)%></a>
							</td>
							<td class="num"><span><%=salesGoods.getQuantity()%></span>件</td>
						</tr>
						<%}}%>
					</table>
				</div>
				...
				<div style="margin-bottom:10px;">
					...
					<td>
						...
						<ul>
							...
							<%}%>
								<span class="discount_price">&yen;<%=Double.toString(goods.getDiscountPrice())%></span>
							</li>
						</ul>
					</td>
					<%
