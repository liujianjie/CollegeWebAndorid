...
function validateEmail(){
	...
	var url = "<%=basePath%>servlet/AjaxGetIsEmailExists";
...
<div id="middle_div">
	...
	<div id="login_div">
		...
		<form name="loginForm" action="servlet/CustomerForwardManage" method="post" target="_top">
	...
	<div id="register_div">
		...
		<form name="registerForm" action="servlet/CustomerForwardManage" method="post">
