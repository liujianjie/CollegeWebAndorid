...
<div id="middle_div">
		...
		<div class="item_content">
			<table align="center">
				...
				<tr>
					...
					<td colspan="3"><%=detail.getAddress()%></td>
				</tr>
			</table>
		</div>
			...
			<table align="center">
				...
				<tr>
					<td colspan="7" class="sum">
						此订单中共有<span><%=items.size()%></span>件商品，总计金额<span><%=cart.getTotalPrice()%></span>元！
					</td>
				</tr>
			</table>
		</div>
	...
	<div class="op">
		<form action="servlet/PayManage" method="post">
