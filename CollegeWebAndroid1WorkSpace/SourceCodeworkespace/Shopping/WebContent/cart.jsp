<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.zuxia.model.Cart"%>
...
<div id="middle_div">
	...
	<form name="changeForm" action="servlet/CartManage" method="post">
...
<div class="sumPrice_div">
	<div class="sum">商品金额总计：<span>&yen;<%=cart.getTotalPrice()%></span>&nbsp;&nbsp;</div>
	<div class="clear"><a href="servlet/CartManage?op=clear">清空购物车</a></div>
</div>
<div class="btn_div">
	您可以&nbsp;<a target="_top" href="servlet/PayManage?op=confirm"><img src="images/jrjs.gif" /></a>
	，也可以&nbsp;<a target="_top" href="index.jsp"><img src="images/jxgm.gif" /></a>
</div>
</div>
