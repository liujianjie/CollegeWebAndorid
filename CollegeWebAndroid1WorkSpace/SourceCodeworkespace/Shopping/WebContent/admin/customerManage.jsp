...
<%	
PageModel<CustomerInfo> pm = (PageModel<CustomerInfo>)request.getAttribute("allCustomers");
if(pm== null){
	pm = new PageModel<CustomerInfo>();
}
ArrayList<CustomerInfo> customerList = null;
customerList = pm.getData();
%>
...
<body>
	<form name="myForm" action="servlet/CustomerManage" method="post" onsubmit="return search_click();">
		<%
