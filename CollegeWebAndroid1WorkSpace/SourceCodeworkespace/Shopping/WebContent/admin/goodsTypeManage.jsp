...
<%	
PageModel<GoodsType> pm = (PageModel<GoodsType>)request.getAttribute("allTypes");
if(pm== null){
	pm = new PageModel<GoodsType>();
}
ArrayList<GoodsType> typeList = pm.getData();
%>
...
<body>
	<form name="myForm" action="servlet/GoodsTypeManage" method="post" onsubmit="return search_click();">
		<%
