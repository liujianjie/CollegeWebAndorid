...
<body>
	<form name="myForm" action="servlet/GoodsManage" method="post" onsubmit="return search_click();">
		<%
	...
	<tr>
		...
		<td><%=goods.getGoodsType().getTypeName()%></td>
		<td><%=StringUtil.omitString(goods.getGoodsName(),80) %></td>
