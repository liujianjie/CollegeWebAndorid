...
<html>
	<head>
		...
		#div_all{position:absolute;width:582px;height:386px;left:50%;top:50%;margin:-193px 0px 0px -291px;background:url(admin/images/login_div_bg.jpg) no-repeat 0px 0px;}
	...
	<body onload="loadPage();">
		<div id="div_all">
			<div id="div_login">
			<form name="loginForm" action="servlet/SystemManage" method="post" onsubmit="return checkLogin();">
