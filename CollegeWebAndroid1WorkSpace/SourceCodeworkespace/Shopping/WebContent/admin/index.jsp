<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="com.zuxia.model.UserInfo"%>
	...
	<body onload="loadPage()">
		...
		<div id="middle_div">
			<div id="middle_left_div">
				<div id="userInfo">
					登录用户：<%=user.getUserName()%><br/>
					登录时间：<%=getLoginTime(session)%>
				</div>
				<div class="title_div">
					公告管理
				</div>
				<ul>
					<li>
						<a href="servlet/BulletinManage?op=toAdd" target="mainFrame">发布公告</a>
					</li>
					<li>
						<a href="servlet/BulletinManage" target="mainFrame">公告管理</a>
					</li>
				</ul>
				<div class="title_div">
					商品管理
				...
				<ul>
					<li>
						<a href="servlet/GoodsManage?op=toAdd" target="mainFrame">添加商品</a>
					</li>
					<li>
						<a href="servlet/GoodsManage" target="mainFrame">商品信息管理</a>
					</li>
					<li>
						<a href="servlet/GoodsTypeManage?op=toAdd" target="mainFrame">添加商品类型</a>
					</li>
					<li>
						<a href="servlet/GoodsTypeManage" target="mainFrame">商品类型管理</a>
					</li>
				</ul>
				<div class="title_div">
					订单管理
				...
				<ul>
					<li>
						<a href="servlet/OrderManage" target="mainFrame">订单信息管理</a>
					</li>
				</ul>
				<div class="title_div">
					客户管理
				...
				<ul>
					<li>
						<a href="servlet/CustomerManage" target="mainFrame">客户信息管理</a>
					</li>
				</ul>
				<div class="title_div">
					系统管理
				...
				<ul>
					...
					<li>
						<a href="servlet/SystemManage?op=loginOut" target="_top">退出系统</a>
					</li>
				</ul>
			</div>
		...
		<div id="bottom_div">&copy;(2015-2015)All Rights Reserved.</div>
	</body>
</html>