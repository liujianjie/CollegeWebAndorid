...
<body>
	...
	<%
		...
		try{
			...
			String sql;
			// 1.增加
			sql = "insert into info values('王婷婷','18')";
			stmt.executeUpdate(sql);
			sql = "insert into info values('小明','28')";
			stmt.executeUpdate(sql);
			sql = "insert into info values('小红','19')";
			stmt.executeUpdate(sql);
			// 2.修改
			sql = "update info set age = '22' where name = '小明'";
			stmt.executeUpdate(sql);
			// 3.删除
			sql = "delete from info where name = '王婷婷'";
			stmt.executeUpdate(sql);
			// 4.查
