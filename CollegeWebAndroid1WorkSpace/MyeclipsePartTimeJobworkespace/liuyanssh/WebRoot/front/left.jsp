...
<div class="treebox">
		<ul class="menu">
			...
			<c:if test = '${fn:contains(UserpreReallist,"9")?"true":"false" }'><li class="level1">
				<a href="#none"><em class="ico ico2"></em>统计管理<i></i></a>
				<ul class="level2">
					<c:if test = '${fn:contains(UserpreReallist,"10")?"true":"false" }'><li><a href="javascript:;">顾客统计</a></li></c:if>
					<c:if test = '${fn:contains(UserpreReallist,"11")?"true":"false" }'><li><a href="javascript:;">订单查询</a></li></c:if>
					<c:if test = '${fn:contains(UserpreReallist,"12")?"true":"false" }'><li><a href="javascript:;">订单统计</a></li></c:if>
				</ul>
			</li>  
			</c:if>
		</ul>
