...
public class GsnBottomLayerInterface extends JFrame{
	...
	public static GsnSettingInterface gsettingjpanel;
	...
	protected void stratProduceOfJPanel(){// 初始化面板
		...
		gsettingjpanel = new GsnSettingInterface();
		...
		gsettingjpanel.setBounds((GsnInterfaceParam.allwidth - GsnInterfaceParam.INTERFACEWIDTH) / 2,(GsnInterfaceParam.allheight - GsnInterfaceParam.INTERFACEHEIGHT) / 2,GsnInterfaceParam.INTERFACEWIDTH, GsnInterfaceParam.INTERFACEHEIGHT);
	}
	protected void stratProduceOfJPanelOp(){// 面板操作
		...
		gsettingjpanel.setVisible(false);
